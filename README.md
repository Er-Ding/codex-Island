...
- **按住顶部移动**：展开后按住最上方的额度栏，移动鼠标即刻拖动，松开保存位置；双击顶部即可复位。
...
| 恢复初始位置 | 双击展开面板最上方的额度栏，回到主屏顶部中央并收起 |
...
不需要等待长按。按住期间只要移动鼠标就会拖动；没有移动时，松开则切换固定 / 取消固定。取消固定后，面板保持展开，鼠标移出后自动收起。

托盘菜单也保留“调整位置…”作为备选：进入后拖动“拖动调整位置”区域，点击“完成”保存，或点击 × 取消。

保存后，重启仍会恢复位置。需要复位时，**双击展开面板最上方的额度栏**，即可回到主屏顶部中央并收起，显示大小设置会保留。托盘菜单中的“恢复默认位置”也继续可用。
